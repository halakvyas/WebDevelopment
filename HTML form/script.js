...
function checkPassword(){ // oninput function
	...
	document.getElementById('size').innerHTML="8 or more characters";
	document.getElementById('character').innerHTML="Uses only these English characters: A-z, 0-9, @, -, _ and .";
	document.getElementById('diff').innerHTML="Your password can not be the same as your user ID.";
	...
	if(same || char){
		if(same){
			document.getElementById('diff').innerHTML='<span style="color:red;">&#10006;</span>&nbsp;Your password can not be the same as your user ID.';
			document.getElementById('current').style.background="red";
			document.getElementById('current').style.width="100%";
		}
		if(char){
			document.getElementById('character').innerHTML='<span style="color:red;">&#10006;</span>&nbsp;Uses only these English characters: A-z, 0-9, @, -, _ and .';
			document.getElementById('current').style.background="red";
			document.getElementById('current').style.width="100%";
		}
		return false;
		...
		if(len){
			document.getElementById('size').innerHTML='<span style="color:green;">&#10004;</span>&nbsp;8 or more characters';
			pass+=25;
		}
